    ...
    public partial class Inicial_canal : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SistemaFinanceuro", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categoria_SistemaFinanceuro_IdSistema",
                        column: x => x.IdSistema,
                        principalTable: "SistemaFinanceuro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "UsusarioSistemaFinanceiro",
                columns: table => new
                {
                    IdSistema = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsusarioSistemaFinanceiro", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsusarioSistemaFinanceiro_SistemaFinanceuro_IdSistema",
                        column: x => x.IdSistema,
                        principalTable: "SistemaFinanceuro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsusarioSistemaFinanceiro_IdSistema",
                table: "UsusarioSistemaFinanceiro",
                column: "IdSistema");
        }
